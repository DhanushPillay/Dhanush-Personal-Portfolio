    ...
    <section id="about" className="py-24 md:py-32 bg-white relative">
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl md:text-4xl font-bold text-[#1c1c1c] mb-6">About Me</h2>
          <div className="max-w-3xl space-y-4 text-zinc-600 text-lg leading-relaxed">
            <p>
        ...
        <motion.div
          ...
          className="flex flex-wrap gap-x-12 gap-y-6 border-t border-zinc-200 pt-8"
        >
          {[
            ...
            <div key={stat.label} className="flex flex-col">
              <span className="text-2xl md:text-3xl font-bold text-[#1c1c1c]">{stat.value}</span>
